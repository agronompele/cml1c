            ...
            if (evt.target.readyState == FileReader.DONE) {
                ...
                xhr.upload.addEventListener("progress", function (evt) {
                    if (evt.lengthComputable) {
                        ...
                        $( "#msg" ).text( "Идет загрузка файла на сервер" );
                ...
                xhr.addEventListener("load", function (evt) {
                    ...
                    if (that.filesize > that.position) {
                        ...
                        $("#msg").text("Подождите, идет процес разархивирования");
                        gxhr.open('POST', that.options['donescript'], true);
                        ...
                        gxhr.addEventListener("load", function (evt) {
                            ...
                            // об успешной загрузке или следующий шаг формы с дополнительным полями.
                                ...
                                $( "#msg" ).text( "Разархивирование завершено" );
